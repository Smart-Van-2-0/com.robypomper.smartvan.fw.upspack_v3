...
from fw_upspack_v3.base.runner import DeviceRunner
from fw_upspack_v3.base.settings import Settings
from fw_upspack_v3.ups.device import Device
from fw_upspack_v3.ups.simulator import DeviceSimulator
from fw_upspack_v3.ups.mappings import PID, PROPS_CODES, CALC_PROPS_CODES
...
FW_SETTINGS = {
    ...
    Settings.FW_NAME: "FW UPS Pack v3",
    ...
    Settings.PARAM_SERIAL_SPEED: 9600,
    # Value to use as default DBus name (default: "com.fw_dbus")
    Settings.PARAM_DBUS_NAME: "com.upspack",
